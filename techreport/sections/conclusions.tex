...
detenctions, the framework reveals a significant limitation by providing no
built-in support for handling such events, thus it leaves the responsability for
handling timing violations entirely to the developers. \\
Finally, we would like to highlight that the \textit{RTIC} framework is still
a valid option for the development of real-time systems, with a generated code
