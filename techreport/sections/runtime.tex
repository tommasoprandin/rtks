...
Unlike \textit{Ada}, which provides a reference runtime implementation, \textit{Rust} delegates this responsibility to third-party developers. This approach offers several advantages: it promotes flexibility and ecosystem development by encouraging competitive runtime development and enabling implementations tailored to specific use cases. However, this approach also causes ecosystem fragmentation
and could also result in lower "quality" of the runtimes, considering that a single
reference implementation will naturally tend to concentrate resources towards its
