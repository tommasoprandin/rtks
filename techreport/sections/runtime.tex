...
\begin{itemize}
  ...
  section} (i.e. lock). 
\end{itemize}
The mapping between tasks and ISR, and resources to their static ceilings is computed at compile-time by \textit{RTIC} using \textit{procedural macros}, thus is has no impact on the performance at runtime.
