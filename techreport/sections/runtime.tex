...
that can work in harmony together i.e. with compatible APIs and functioning in
the chosen runtime environment. In our case this means choosing a
...
priority against the system ceiling. 
...
suspension points, eliminating the need for manual state machine implementations
