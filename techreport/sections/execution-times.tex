...
Concerning the Ada system, we have re-utilized the instrumentation implemented by J. Hu and A. Gobbo in their work \cite{huJiayihuSRT2024}, aimed to perform response-time analysis over the same system model shown in the original paper \cite{burnsGuideUseAda2004}.
